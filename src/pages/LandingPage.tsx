...
const MascotCharacter = () => (
    <div className="relative w-[300px] h-[300px] sm:w-[350px] sm:h-[350px] md:w-[450px] md:h-[450px] flex items-center justify-center">
        <div className="absolute w-full h-full">
            <svg viewBox="0 0 100 100" className="w-full h-full text-cyan-300 drop-shadow-2xl">
        ...
        <div className="absolute top-16 right-0 md:top-24 md:right-5 bg-blue-500 text-white px-4 py-2 rounded-xl shadow-lg">
            ...
            <p className="text-xs max-w-[100px]">Active Learners &<br/>Changemakers</p>
        </div>
    </div>
);
...
const testimonials = [
    { quote: "A terrific piece of praise", name: "Name", description: "Description", img: "https://i.pravatar.cc/50?img=1" },
    { quote: "A fantastic bit of feedback", name: "Name", description: "Description", img: "https://i.pravatar.cc/50?img=2" },
    { quote: "A genuinely glowing review", name: "Name", description: "Description", img: "https://i.pravatar.cc/50?img=3" },
];
        ...
        <div className="space-y-16 md:space-y-24">
            ...
            <section className="relative container mx-auto">
                <div className="absolute top-1/2 -translate-y-1/2 left-0 md:-left-12">
                     <button className="bg-white/80 backdrop-blur-sm p-3 rounded-full shadow-md hover:bg-white transition" aria-label="Previous Slide">
                        <ChevronIcon direction="left" />
                    </button>
                </div>
                <div className="absolute top-1/2 -translate-y-1/2 right-0 md:-right-12">
                     <button className="bg-white/80 backdrop-blur-sm p-3 rounded-full shadow-md hover:bg-white transition" aria-label="Next Slide">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center pt-8">
                    <div className="text-center md:text-left">
                        ...
                        <p className="mt-4 text-gray-600 max-w-lg mx-auto md:mx-0">
                            First Indonesian super-app about all things youth empowerment, built for youth, students, and achievers. Discover your purpose and make grounbreaking impact.
                        </p>
                        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                            <Link to="/signup" className="px-8 py-3 font-semibold text-white bg-gradient-to-r from-cyan-400 to-blue-500 rounded-lg shadow-md hover:scale-105 transform transition-transform">Join Now</Link>
                            <a href="#" className="flex items-center gap-2 text-indigo-700 font-semibold hover:text-indigo-900 transition-colors">
                ...
                <div className="mt-12 flex items-center space-x-4 p-2 bg-white rounded-2xl shadow-lg max-w-2xl mx-auto">
                    <div className="flex-grow bg-gray-100 h-16 rounded-xl" aria-hidden="true"></div>
                    <div className="bg-indigo-600 w-32 h-16 rounded-xl" aria-hidden="true"></div>
                </div>
            </section>

            {/* Features Section */}
            <section className="container mx-auto text-center">
                <h2 className="text-4xl font-bold text-[#1E1F4B] mb-12">Discover awesome features!</h2>
                        ...
                        <Link to={`/course/${course.id}`} key={course.id} className="block group">
                            <div className="bg-white rounded-2xl shadow-lg overflow-hidden h-full flex flex-col transform group-hover:-translate-y-2 transition-transform duration-300">
                                ...
                                <div className="p-6 flex flex-col flex-grow">
                                    <h3 className="text-xl font-bold text-gray-800 flex-grow">{course.title}</h3>
            ...
            <section className="container mx-auto py-16">
                 <div className="text-left max-w-3xl">
                   <h2 className="text-4xl font-bold text-[#1E1F4B] mb-8">Section heading</h2>
                    ...
                    <div className="mt-8 flex gap-4">
                       <button className="px-8 py-3 bg-[#1E204B] text-white font-semibold rounded-lg shadow-md hover:bg-black transition-colors">Button</button>
                       <button className="px-8 py-3 bg-gray-200 text-gray-800 font-semibold rounded-lg hover:bg-gray-300 transition-colors">Secondary button</button>
                    </div>
                </div>
            </section>
            ...
            {/* Image Section */}
            <section className="container mx-auto">
                 <h2 className="text-4xl font-bold text-[#1E1F4B] mb-12 text-center">Section heading</h2>
